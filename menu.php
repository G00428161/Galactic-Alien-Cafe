        ...
        <div class="cart-container">
            ...
            <ul>
                ...
                foreach ($_SESSION['cart'] as $index => $item) {
                    // only show menu items on this page
                    if (!isset($item['type']) || $item['type'] !== 'menu') continue;
                ...
                <?php endforeach; ?>
                    ...
                    <!-- ✅ CHECKOUT BUTTON (only when cart not empty) -->
                    <li class="checkout-line" style="text-align:center; margin-top:10px;">
